...
<%@ Page Language="C#" CodeBehind="AppToHireWorkflowApproval.aspx.cs" Inherits="HRWebForms.HRWeb.AppToHireWorkflowApproval" MasterPageFile="~sitecollection/_catalogs/masterpage/SunRice.v4.master" %>

<asp:Content ID="Content1" ContentPlaceHolderID="PlaceHolderPageTitle" runat="server">Application To Hire Workflow Approval</asp:Content>
            ...
            <div id='hr-web' class="clearfix">
                ...
                <asp:GridView ID="DraftGrid" runat="server" AutoGenerateColumns="false" Width="100%" AllowSorting="true"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="Role" HeaderText="Name/Position/Role" ReadOnly="True" SortExpression="Role">
                            <HeaderStyle Width="26%" Wrap="true" HorizontalAlign="Left" ForeColor="White" />
                            <ItemStyle Width="26%" Wrap="true" VerticalAlign="Top" />
                        </asp:BoundField>
                ...
                <asp:GridView ID="ApprovedGrid" runat="server" AutoGenerateColumns="false" Width="100%" AllowSorting="true"
                    ...
                    <Columns>
                        <asp:BoundField DataField="DateApproved" HeaderText="Date Approved" ReadOnly="true" SortExpression="DateApproved">
                            <HeaderStyle Width="10%" HorizontalAlign="Left" ForeColor="White" />
                            <ItemStyle Width="10%" VerticalAlign="Top" />
                        </asp:BoundField>
                        <asp:BoundField DataField="Initiator" HeaderText="Initiator" ReadOnly="True" SortExpression="Initiator">
                ...
                <asp:GridView ID="RejectedGrid" runat="server" AutoGenerateColumns="false" Width="100%" AllowSorting="true"
                    ...
                    <Columns>
                        <asp:BoundField DataField="DateApproved" HeaderText="Date Rejected" ReadOnly="true" SortExpression="DateApproved">
                            <HeaderStyle Width="10%" HorizontalAlign="Left" ForeColor="White" />
                            <ItemStyle Width="10%" VerticalAlign="Top" />
                        </asp:BoundField>
                        <asp:BoundField DataField="Initiator" HeaderText="Initiator" ReadOnly="True" SortExpression="Initiator">
                        ...
                        <asp:BoundField DataField="RejectedBy" HeaderText="Rejected By" ReadOnly="True" SortExpression="RejectedBy">
                            <HeaderStyle Width="15%" Wrap="true" HorizontalAlign="Left" ForeColor="White" />
                            <ItemStyle Width="15%" Wrap="true" VerticalAlign="Top" />
                        </asp:BoundField>
                        <asp:BoundField DataField="ID" HeaderText="ID" ReadOnly="True" SortExpression="ID" Visible="false">
